...
Step 1. Install TXL
    ...
    Make sure that the unzipped TXL distribution folder is on the Desktop.
    Right-click on the "InstallTxl" script in this folder and choose
    "Run as Administrator".  Authorize the script to continue when asked.
